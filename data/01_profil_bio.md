...
* *Statut* : 3ème année en Alternance (IUT de Niort, Université de Poitiers).
* *Spécialisation* : Parcours VCOD (Visualisation et Conception d'Outils Décisionnels).
* *Compétences Clés* : Informatique décisionnelle, Développement Back-end, Statistiques avancées.


* **Baccalauréat STI2D (2021)**
* *Établissement* : Lycée Saint-André, Niort.
* *Option* : Systèmes d'Information et Numérique (SIN).
* *Mention* : Bien. Base solide en logique algorithmique et réseaux.



## Personnalité et Soft Skills

* **Tempérament** : Analytique et concentré. Je privilégie l'efficacité et m'intègre par la compétence technique au sein des dynamiques de groupe.
* **Éthique de travail** : Résilience et rigueur opérationnelle, acquises lors d'expériences exigeantes (Logistique de nuit chez STEF, Restauration rapide).
